...
```shell
python tools/train2017.py -f exps/default/yolox_s.py -d 8 -b 64 --fp16 -o [--cache]
...
```shell
python tools/train2017.py -n yolox-s -b 128 --dist-url tcp://123.123.123.123:12312 --num-machines 2 --machine-rank 0
```
On the second machine, run
```shell
python tools/train2017.py -n yolox-s -b 128 --dist-url tcp://123.123.123.123:12312 --num-machines 2 --machine-rank 1
```
